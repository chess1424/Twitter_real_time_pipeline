...
object SearchStreamer {
  def main(args: Array[String]) {
    val twitterListener = TwitterUtil.createListener("twitter-streamer", "twitter")
    ...
    twitterStream.filter(new FilterQuery().track(Array("AMLO", "TRUMP", "ooyala", "OOYALA", "Ooyala")))
